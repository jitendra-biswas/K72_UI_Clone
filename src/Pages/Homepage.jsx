       ...
       <div className="w-full h-screen">
        ...
        <div className="homepage-container w-full h-full absolute left-0 top-0">
          <div className="top flex flex-col items-center text-zinc-200">
            ...
            <h1 className="font-[font1] uppercase text-[9vw] leading-[9vw] flex items-center">
              qui{" "}
            ...
            <h1 className="font-[font1] uppercase text-[9vw] leading-[9vw]">
              la créativité
            </h1>
          </div>
          <div className="middle w-full flex justify-end">
            <p className="w-[20vw] font-[font2] text-white text-sm pr-3">
          ...
          <div className="bottom flex justify-center gap-5">
            <Link to="/projects" className="uppercase text-white text-8xl font-[font2] border-2 rounded-full px-5 py-2 hover:text-[#D3FD50] transition-all">projects</Link>
            <Link to="/agence" className="uppercase text-white text-8xl font-[font2] border-2 rounded-full px-5 py-2 hover:text-[#D3FD50] transition-all">agence</Link>
          </div>
        </div>
      </div>
    </>
